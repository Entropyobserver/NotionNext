...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Entropyobserver', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'I’m a seeker in the realm of technology', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.techenglish.top, // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Entropyobserver', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi, I’m a seeker in the realm of technology—a programmer exploring code. Welcome to my blog, where innovation meets inspiration!',
